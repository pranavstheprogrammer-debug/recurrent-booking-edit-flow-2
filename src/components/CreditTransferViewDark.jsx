...
// ============================================================================
// INLINE CREDIT TIME INPUT - Dark theme (replaces popover to prevent overflow)
// ============================================================================
  ...
  return (
    <div className="mt-2 pt-2 border-t border-slate-700 animate-fadeIn">
      ...
      <div className="flex items-center justify-between gap-1">
        <span className="text-[8px] text-slate-500 uppercase font-medium">Manual</span>
        <div className="flex items-center gap-1 bg-slate-700/50 rounded-lg px-1 py-0.5">
          <button
            onClick={(e) => {
              e.stopPropagation();
              adjustTime(-15);
            }}
            className="w-5 h-5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-slate-600 rounded transition-colors"
          >
          ...
          <input
            ...
            className="w-10 h-5 text-center text-[11px] font-bold font-mono bg-transparent
                       text-slate-200 border-none outline-none focus:ring-0"
          />
          <button
            onClick={(e) => {
              e.stopPropagation();
