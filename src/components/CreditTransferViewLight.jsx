...
/**
 * NORTAVIA Credit Transfer View - LIGHT THEME
 * Full light mode version of the PLAR (Prior Learning Assessment and Recognition) interface
 */
  ...
  const objectiveStats = useMemo(() => {
    return OBJECTIVE_TYPES.map(objective => {
      ...
      sections.forEach(section => {
        ...
        // Add section-level manual credits
        sectionManualCredits += manualCredits[section.id]?.[objective.key] || 0;
      });

      // Add global manual credits + section-level manual credits
    ...
    <div className="mt-4">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] text-gray-400 px-1.5 py-0.5 bg-gray-100 rounded-md">
            Click + to add credit
          </span>
        </div>
        ...
        {objectiveStats.map(obj => {
          ...
          return (
            <div
              key={obj.key}
              className={`
                relative group p-2 rounded-lg transition-all duration-200 border
                ${obj.isComplete
            ...
            >
              ...
              <div className="flex items-baseline gap-0.5 font-mono">
                <span className={`text-sm font-bold ${obj.isComplete ? 'text-emerald-600' : 'text-gray-800'}`}>
                  {formatTime(obj.credited)}
                </span>
                <span className="text-[10px] text-gray-400">/</span>
                <span className="text-[10px] text-gray-500">{formatTime(obj.required)}</span>
              </div>
      ...
      <div className="relative">
        <input
          ...
          className={`
            ...
            border-2 border-blue-500 rounded-lg bg-white text-gray-900
...
// ============================================================================
// SECTION MANUAL CREDIT COMPONENT - Clean expandable row for section-level credits
// ============================================================================
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    ${value > 0 ? `${colors.bg} ${colors.border} border` : 'bg-white border border-gray-100'}
                  `}
                >
...
// ============================================================================
// EVENT CARD COMPONENT - LIGHT THEME
// ============================================================================
...
// ============================================================================
// TRAINING SECTION COMPONENT - LIGHT THEME
// ============================================================================
...
const CreditTransferViewLight = ({
  ...
  // Handler for manual credit changes (both global and section-level)
        ...
        <div className="bg-white text-gray-900 border-b border-gray-200">
          ...
          <div className="flex justify-between items-center px-5 py-2.5 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <span className="px-2 py-0.5 bg-amber-50 border border-amber-200 rounded-md text-[10px] font-medium text-amber-700 flex items-center gap-1">
                <SunIcon />
                LIGHT MODE
              </span>
            </div>
...
export default CreditTransferViewLight;
