...
const TrainingEventRowV2 = ({ event, isExpanded, onToggle }) => {
  ...
  return (
    ...
    `}>
      ...
      <div
        className="grid grid-cols-[24px_1fr_140px_140px_60px] gap-3 items-center px-4 py-3 cursor-pointer hover:bg-gray-50/50 transition-colors"
        onClick={onToggle}
      >
        {/* Expand Button */}
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      `}>
        <div className="p-4 space-y-2 border-t border-gray-100">
          ...
          <div className="hidden lg:grid grid-cols-[24px_1fr_140px_140px_60px] gap-3 px-4 py-2 text-[10px] font-semibold text-gray-500 uppercase tracking-wide border-b border-gray-100 mb-2">
            <div></div>
