    ...
    <Modal isOpen={isOpen} onClose={onClose} size="xl">
      <div className="flex h-[80vh] max-h-[700px]">
        ...
        <div className="w-2/5 bg-gradient-to-b from-gray-50 to-gray-100 border-l border-gray-200 flex flex-col">
          ...
          {editScope === 'series' && (
            <div className="mx-5 mt-3 px-3 py-2 bg-amber-50 rounded border border-amber-200 flex items-center gap-2">
              <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <span className="text-sm text-amber-800">Bulk edit mode – changes cannot be undone</span>
            </div>
          )}
